export const translations = {
  en: {
    ...
    coaching: {
      ...
      tryAgain: "Try again",
      aiThinking: "GuruVaani is thinking...",
      cards: {
    ...
    planner: {
      ...
      videoSuggestions: "Video Suggestions for Classroom",
    },
    ...
    videoSupport: {
      ...
      noVideosFound: "No videos found for this topic",
    },
  ...
  hi: {
    ...
    coaching: {
      ...
      aiThinking: "गुरुवाणी सोच रही है...",
      cards: {
    ...
    planner: {
      ...
      teacherTip: "शिक्षक सुझाव",
      errorGeneratingPlan: "योजना बनाने में विफल। कृपया पुन: प्रयास करें।",
      videoSuggestions: "कक्षा के लिए वीडियो सुझाव",
    },
    ...
    videoSupport: {
      ...
      noVideosFound: "इस विषय के लिए कोई वीडियो नहीं मिला",
    },
